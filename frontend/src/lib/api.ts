...
export const api = {
  ...
  addTicker: (data: { ticker: string; company_name: string; sector?: string }) => fetchAPI("/api/watchlist", { method: "POST", body: JSON.stringify(data) }),
  ...
  createJournalEntry: (data: { ticker: string; entry: string; sentiment?: string; category?: string }) =>
    fetchAPI("/api/journal", { method: "POST", body: JSON.stringify(data) }),
  updateJournalEntry: (id: number, data: { entry?: string; sentiment?: string; category?: string }) =>
