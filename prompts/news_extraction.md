...
changelog:
  ...
  - "0.3: Entity-Relevanz-Check ergänzt (Groq-Umstieg)"
---
...
ENTITY-RELEVANZ:
Prüfe ob die Nachricht den Ticker {{ticker}} DIREKT betrifft oder ob der Ticker nur am Rande erwähnt wird (z.B. als Vergleich oder Kontext).
...
Antworte NUR mit folgendem JSON-Objekt. Keine Erklärungen, kein Markdown um das JSON herum (nur reiner Text):
{
  ...
  "relevance_reason": "1 Satz warum relevant/nicht"
}

Wenn is_directly_relevant false ist, setze bullet_points auf [] und is_narrative_shift auf false.
